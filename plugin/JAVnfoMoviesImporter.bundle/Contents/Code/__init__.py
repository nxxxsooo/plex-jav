...
def get_gfriends_www():
    request_url = 'https://raw.githubusercontent.com/gfriends/gfriends/master/Filetree.json'
...
def get_local_filetree():
    return '/config/Library/Application Support/Plex Media Server/Plug-ins/JAVnfoMoviesImporter.bundle/Filetree.json'
    # 原路径：暂时留存:Core.storage.join_path(Core.app_support_path, Core.config.bundles_dir_name, 'JAVnfoMoviesImporter.bundle', 'Filetree.json')
...
def get_gfriends_map():
    github_template = 'https://raw.githubusercontent.com/gfriends/gfriends/master/Content/{}/{}'
